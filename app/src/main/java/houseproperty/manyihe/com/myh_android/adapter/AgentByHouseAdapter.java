...
public class AgentByHouseAdapter extends RecyclerView.Adapter<AgentByHouseAdapter.MyViewHolder> {
    private Context context;
    private List<AgentByHouse.ResultBeanBean.ObjectBean.ListBean> agentList;

    public AgentByHouseAdapter(Context context, List<AgentByHouse.ResultBeanBean.ObjectBean.ListBean> agentList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.agent_by_house_adapter, null);
