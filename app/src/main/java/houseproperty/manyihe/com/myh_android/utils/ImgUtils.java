...
public class ImgUtils extends android.support.v7.widget.AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    /** 表示是否只有一次加载 */
    ...
    public ImgUtils(Context context, AttributeSet attrs) {
    ...
    public ImgUtils(Context context, AttributeSet attrs, int defStyle) {
