...
public class NewHouseFloorDetailsActivityAdapter extends RecyclerView.Adapter<NewHouseFloorDetailsActivityAdapter.MyViewHolder> {
    private Context context;
    private List<HousingResourceHotFloorBean.ResultBeanBean.ObjectBean.ListBean> hotDetails;

    public NewHouseFloorDetailsActivityAdapter(Context context, List<HousingResourceHotFloorBean.ResultBeanBean.ObjectBean.ListBean> hotDetails) {
